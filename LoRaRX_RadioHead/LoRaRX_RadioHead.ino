...
char auth[] = "616f1661663343d09c88268a22a3c49f";
...
WidgetLED unitOnline(V1);
WidgetLED systemEnabled(V2);
WidgetLED augerStatus(V3);
...
void loop()
{
  if (sending && rf95.waitAvailableTimeout(200))  
  {
